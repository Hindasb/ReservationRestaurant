...
def ajout_vip_table(request):
    if request.method=="POST":
        ...
        tel = request.POST['tel']
        email = request.POST['email']
        nombre_personne_adulte = request.POST['nombre_personne_adulte']
        nombre_personne_enfant = request.POST['nombre_personne_enfant']
        chaise_enfant = request.POST.get('chaise_enfant', False) == 'on'
        information_sur_plats = request.POST['information_sur_plats']
        ...
        try:
            ...
            if date_reservation  != Reservation_table.date_reservation:
                client = Client.objects.create(nom=nom, prenom=prenom, tel=tel, email=email)
                r = Reservation_table.objects.create(client=client, table=table, date_reservation=date_reservation, disponiblité=True, nombre_place=nombre_place, type_evenement=type_evenement, nombre_personne_adulte=nombre_personne_adulte, nombre_personne_enfant=nombre_personne_enfant, chaise_enfant=chaise_enfant,information_sur_plats=information_sur_plats)
                client.save()
                r.save()
                idd = r.id
...
def ajout_vip_table_admin(request):
    if request.method=="POST":   
        ...
        try:
           ...
           if date_reservation  != Reservation_table.date_reservation :
              client = Client.objects.create(nom=nom, prenom=prenom, tel=tel, email=email)
              r = Reservation_table.objects.create(client = client, table=table, date_reservation = date_reservation , nombre_place=nombre_place, type_evenement=type_evenement, nombre_personne_adulte=nombre_personne_adulte, nombre_personne_enfant=nombre_personne_enfant, chaise_enfant=chaise_enfant,information_sur_plats=information_sur_plats)
              client.save()
              r.save() 
              idd = r.id
              return render(request, 'Reservation/impression_table_admin.html',{'idd': idd}) 
    ...
    if not request.user.is_authenticated:
        ...
        if request.method=="POST":   
            ...
            r = Reservation_salle.objects.create(client = client, salle=salle, 
                                                    ...
                                                    nombre_personne_adulte=nombre_personne_adulte, 
                                                    nombre_personne_enfant=nombre_personne_enfant, 
                                                    chaise_enfant=chaise_enfant,
                                                    information_sur_plats=information_sur_plats)
            client.save()
            r.save()
            idd = r.id;
            return render (request, 'Reservation/impression_salle_admin.html', {'idd': idd}) 
...
def ajout_vip_salle(request):
    if request.method=="POST":   
        ...
        r = Reservation_salle.objects.create(client = client, salle=salle, 
                                             date_reservation = date_reservation,
                                             nombre_table=nombre_table,
                                             type_evenement=type_evenement,nombre_personne_adulte=nombre_personne_adulte, nombre_personne_enfant=nombre_personne_enfant, chaise_enfant=chaise_enfant,information_sur_plats=information_sur_plats)
        client.save()
        r.save()
        idd = r.id;
...
def ajout_normal_salle(request):
    if request.method=="POST":   
        ...
        r = Reservation_salle.objects.create(client = client, salle=salle,
                                             nombre_table =nombre_table,
                                             date_reservation = date_reservation,
                                             type_evenement = type_evenement, nombre_personne_adulte=nombre_personne_adulte, nombre_personne_enfant=nombre_personne_enfant, chaise_enfant=chaise_enfant,
                                             information_sur_plats=information_sur_plats
                                             )
        client.save()
        r.save()
